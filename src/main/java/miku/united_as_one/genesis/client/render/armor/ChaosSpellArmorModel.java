...
public class ChaosSpellArmorModel<T extends LivingEntity> extends EntityModel<T> {
	...
	public ChaosSpellArmorModel(ModelPart root) {
	...
	public void copyFrom(HumanoidModel<?> source, EquipmentSlot slot) {
		...
		this.bipedHead.copyFrom(source.head);
		this.bipedBody.copyFrom(source.body);
		this.bipedRightArm.copyFrom(source.rightArm);
		this.bipedLeftArm.copyFrom(source.leftArm);
		this.bipedRightLeg.copyFrom(source.rightLeg);
		this.bipedLeftLeg.copyFrom(source.leftLeg);
		setSlotVisible(slot);
	}

	private void setSlotVisible(EquipmentSlot slot) {
		setAllVisible(false);
		switch (slot) {
			case HEAD -> this.bipedHead.visible = true;
			case CHEST -> {
				this.bipedBody.visible = true;
				this.bipedRightArm.visible = true;
				this.bipedLeftArm.visible = true;
			}
			case LEGS -> {
				this.bipedBody.visible = true;
				this.bipedRightLeg.visible = true;
				this.bipedLeftLeg.visible = true;
			}
			case FEET -> {
				this.bipedRightLeg.visible = true;
				this.bipedLeftLeg.visible = true;
	...
	private void setAllVisible(boolean visible) {
		this.bipedHead.visible = visible;
		this.bipedBody.visible = visible;
		this.bipedRightArm.visible = visible;
		this.bipedLeftArm.visible = visible;
		this.bipedLeftLeg.visible = visible;
		this.bipedRightLeg.visible = visible;
	}
	@Override
