...
public class MeteorStarRenderer extends EntityRenderer<MeteorStarEntity> {
    ...
    @Override
    public void render(@NotNull MeteorStarEntity entity, float entityYaw, float partialTicks, @NotNull PoseStack poseStack,
    ...
    @Override
    public @NotNull ResourceLocation getTextureLocation(@NotNull MeteorStarEntity entity) {
        return TEXTURE;
    }
