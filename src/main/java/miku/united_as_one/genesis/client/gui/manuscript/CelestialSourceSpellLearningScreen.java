...
@OnlyIn(Dist.CLIENT)
public class CelestialSourceSpellLearningScreen extends SpellLearningScreen {
    public CelestialSourceSpellLearningScreen(Component title, InteractionHand activeHand) {
    ...
    protected AbstractSpell getSchoolFilter() {
        return new AbstractSpell() {
            ...
            public ResourceLocation getSpellResource() {
                return Genesis.id("celestial_source_filter");
            }
    ...
    protected boolean isCorrectManuscript() {
        return Minecraft.getInstance().player != null
                && Minecraft.getInstance().player.getItemInHand(activeHand).is(ItemRegistry.CELESTIAL_SOURCE_MANUSCRIPT.get());
    }
